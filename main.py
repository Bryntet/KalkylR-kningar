...
class Gig:
    ...
    def output(self):
        ...
        output = {
            ...
            "avkastWithoutPris": -1
            * self.avkastning,  # Jag var lite dum i huvet när jag la in avkastning i airtable
            "avkast2": -1
            * self.teoretisk_avkastning,  # Men basically så plussar jag avkastningen istället för minus, därför så har jag en negativ avkastning......
